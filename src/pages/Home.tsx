      ...
      {/* Hero / Spotlight Section */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <Link
            ...
            className="flex-1 group relative overflow-hidden bg-white dark:bg-zinc-900 p-4 rounded-2xl transition-all hover:scale-[1.01] active:scale-[0.98] shadow-xl border border-zinc-200 dark:border-zinc-800"
          >
            <div className="absolute top-0 inset-e-0 w-32 h-32 bg-emerald-500/10 blur-3xl rounded-full" />
            <div className="relative flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-zinc-900 dark:text-white font-headline font-black text-lg tracking-tight">AI Therapist</h3>
                  <p className="text-zinc-500 dark:text-zinc-400 text-[10px] font-black uppercase tracking-[0.2em] mt-1">24/7 Support</p>
                </div>
              </div>
              <div className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 flex items-center justify-center group-hover:bg-emerald-500/20 transition-colors">
                <ChevronRight className={clsx("w-5 h-5 text-zinc-500 group-hover:text-emerald-500 transition-transform", isRTL ? "rotate-180" : "")} />
              </div>
            </div>
          </Link>
        </div>
