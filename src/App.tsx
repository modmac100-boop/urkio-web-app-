          ...
          userDocUnsubscribe = onSnapshot(userRef, async (userSnap) => {
            if (userSnap.exists()) {
              ...
              const newUserData: any = {
                ...
                role: isCaseManager ? 'case_manager' : (isExpert ? 'specialist' : 'user'), 
                verificationStatus: (isExpert || isCaseManager) ? 'pending' : 'none',
                isOnline: true, 
                lastActive: serverTimestamp(),
                ...
                primaryRole: signUpData?.primaryRole || (isExpert ? 'Expert' : ''),
                skills: signUpData?.skills || '',
                npiNumber: signUpData?.npiNumber || '',
                baaAccepted: signUpData?.baaAccepted || false,
                userType: isExpert ? 'expert' : (isCaseManager ? 'case_manager' : 'user'),
